...
export default class confirm extends Component {
    ...
    componentDidMount = async() =>{
        ...
        if (userId == null) {
                ...
                const fetchUrl = url + '/order/user/' + userId +'?status=CONFIRM';
                fetch(fetchUrl, {
                    method: 'GET',
                    headers: {
            ...
            return(
                <View style={styles.columnContainer} key={i}>
                    ...
                    onPress={() => this.viewOrderPage(item.id)}>
                        <View style={{backgroundColor:"#468da6", borderTopStartRadius: 10, borderTopRightRadius:10, height: 70, justifyContent: 'center'}}>
