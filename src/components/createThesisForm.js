...
export default class createThesisForm extends Component {
    ...
    createDocument = async () =>{
        ...
        if(this.state.copies==null || this.state.pages==null || this.state.data==null ||this.state.filename==null){
            ...
            body: JSON.stringify({
                ...
                coverColour: this.state.coverColour,
    ...
    render() {
        ...
        return(
            <ScrollView style={styles.container}>
                ...
                <View style={styles.dropdownSelect}>
                    <Text style={styles.placeholderIndicator}>Choose cover colour</Text>
                    <RNPickerSelect
                    placeholder={placeholder2}
                    style={pickerStyle}
                    value={this.state.coverColour}
                    onValueChange={(value) => this.setState({coverColour: value})}
                    items={[
                ...
                <View style={styles.dropdownSelect}>
                    <Text style={styles.placeholderIndicator}>Choose cover  type</Text>
                    <RNPickerSelect
                    placeholder={placeholder2}
                    style={pickerStyle}
                    value={this.state.CoverType}
                    onValueChange={(value) => this.setState({CoverType: value})}
                    items={[
